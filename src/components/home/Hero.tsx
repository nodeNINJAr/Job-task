...
<section className='bg-banner min-h-[1000px] pb-40'>
    ...
    <div className='max-w-6xl m-auto flex flex-col items-start justify-center space-y-8'>
        ...
        <div className='text-left'>
            <span className="text-xl font-rubik font-medium text-[#749B3F] bg-[#749B3F1A] py-1 px-3 rounded-md">Welcome to Fresh Harvest</span>
            <h1 className="text-7xl text-primary font-medium mt-5 mb-4 leading-20">Fresh Fruits and <br/> Vegetables</h1>
            ...
            {/* discount badge */}
            <div className='mt-8 inline-flex justify-start items-center bg-[#EBEBEB] rounded-xl py-2 px-3 ml-60'>
                <div className='flex flex-col items-start justify-center'>
                   <span className='text-[#176D38] font-rubik font-semibold text-sm'>Special Offer</span>
                    <h3 className='text-3xl font-medium font-rubik mt-1 text-primary'>Fresh Salad</h3>
                    <p className='text-base font-rubik font-semibold mb-2'>Up to <strong>70%</strong> off</p>
                    <h3 className="bg-[#176D38] text-white font-semibold text-[12px] inline-block py-[6px] px-3 rounded-full">CODE: <span className="text-[#FAC714]">FRESH28</span></h3>
                 </div>
                <div><img src="https://i.ibb.co.com/nMZCVsbh/img-1.png" alt='food-image' width={149} height={146}/></div>
            </div>
            {/* hero footer */}
            <div className='mt-6'>
                <h3 className="mb-3 text-[12px] font-medium">Download App:</h3>
                    <div className=" flex gap-5 space-y-2">
                    <Button variant="outline" className="justify-start bg-primary text-white size-4/12">
